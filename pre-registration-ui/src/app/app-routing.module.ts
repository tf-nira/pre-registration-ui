...
import { FaqCitizenComponent } from "./core/faq-citizen/faq-citizen.component";
...
const appRoutes: Routes = [
  {
    path: ":userPreferredLanguage/dashboard",
    loadChildren: "./feature/dashboard/dashboard.module#DashboardModule",
  },
  { path: "about-us", component: AboutUsComponent },
  { path: "faq", component: FaqComponent },
  { path: "faq-citizen", component: FaqCitizenComponent },
...

  {
    ...
    children: [
      ...
      {
        path: "demographic/:appId",
        loadChildren:
          "./feature/demographic/demographic.module#DemographicModule",
      },
      {
        path: "file-upload/:appId",
        loadChildren:
          "./feature/file-upload/file-upload.module#FileUploadModule",
      },
      {
        path: "summary/:appId",
